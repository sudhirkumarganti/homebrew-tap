...
class CloudLearn < Formula
  ...
  url "https://github.com/sudhirkumarganti/cloud-learn/releases/download/v1.1.10/cloud-learn-1.1.10.tar.gz"
  sha256 "4a53c17fb6d15369ca87a3912a803bc4ea83e54cddf8ccae6cb7c1e55ec674fc"
  license "MIT"
  version "1.1.10"
  ...
  # `caveats` instead — users install them via `brew install --cask`.
